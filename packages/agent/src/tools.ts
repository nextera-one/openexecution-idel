...
export function systemPrompt(service: TerminalService): string {
  ...
  return [
    ...
    "   real run only after they confirm. Pure reads (read.file, list.folder, show.path,",
    "   list.registry, explain.registry, list.logs, show.logs) can run directly.",
...
export function cliSystemPrompt(service: TerminalService): string {
  ...
  return [
    ...
    "  Pure reads (read.file, list.folder, show.path, list.registry, explain.registry,",
    "  list.logs, show.logs) can use dryRun:false.",
